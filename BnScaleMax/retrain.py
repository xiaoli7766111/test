...
import random
import time
from BnScaleMax.Main_tool import dataset
...
parser.add_argument('--save', default='LOG_10000/fine/r16_A/m12', type=str, metavar='PATH',
...
parser.add_argument('--refine', default='LOG_10000/prune/r16_A/m12/pruned.pth', type=str, metavar='PATH',
